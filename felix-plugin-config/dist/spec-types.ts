...
export interface SliderSpec {
  ...
  /** The "secondary type" column */
  readonly secondaryType?: string
  /** The info-box description */
  readonly hoverDescription?: string
  /** The extensive description (book icon) */
  readonly extensiveDescription?: string
  /** Whether this slider should be rendered as a segmented button */
  readonly isSegmented?: string
  /** Material UI Icon */
  readonly muiIcon?: string
}
...
export interface SwitchSpec {
  ...
  /** The info-box description */
  readonly hoverDescription?: string
  /** The label for the Second Button of the Switch  */
...
export interface GraphSpec {
  ...
  /** "graph layout" column */
  readonly graphLayout?: string
  /** "scenario mode" column */
  readonly scenarioMode?: string
  /** "classification" column */
  readonly classification?: string
  /** "levels" column */
  readonly levels?: string
  /** "scenario display" column */
  readonly scenarioDisplay?: string
  /** "scale" column */
  readonly scale?: string
  /** "extensive description" column */
  readonly extensiveDescription?: string
}
