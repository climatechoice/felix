...
<img src="diagrams/flw_sc.png" alt="flw sc Diagram" style="display: block; margin: 0 auto 20px auto; max-width: 450px; width: 100%; height: auto;">
...
(1) **Primary Production.** Crops are harvested or animals raised for food. _Losses occur due to:_
...
(2) **Post-Harvest** Food is collected, sorted, cleaned, and stored before further processing or transport. _Losses occur due to:_
...
(3) **Processing.** Raw food is transformed into consumer-ready products (e.g., milling, canning, freezing). _Losses occur due to:_
- Trimming and processing waste (e.g., peels, bones, offcuts)
- Quality control rejections
- Overproduction or batch spoilage

(4) **Distribution.** Food is transported to retailers and sold to consumers. _Losses occur due to:_
...
(5) **Consumption.** Food is purchased, prepared, and eaten by consumers or served in food services. _Waste occurs due to:_
...
### Reference Food Loss and Waste Scenario
...
_Estimated food loss and waste (%) by supply chain stage and food category, derived from Cecilia et al. ([2019](https://link.springer.com/chapter/10.1007/978-3-030-10961-5_11)) based on FAO statistics._
