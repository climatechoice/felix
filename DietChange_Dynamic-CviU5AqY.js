const e=`## Diet Change Population Dynamics Scenario\r
\r
<img src="diagrams/diet_cld.png" alt="Behavioral Drivers" style="float: left; margin: 0 30px 20px 0; width: 350px;">\r
\r
_Based on:_ Eker, S., Reese, G., Obersteiner, M. (2019). Modelling the drivers of a widespread shift to sustainable diets. _Nature Sustainability_, 2(8), 725-735. [https://doi.org/10.1038/s41893-019-0331-1](https://doi.org/10.1038/s41893-019-0331-1)\r
\r
### Overview and Structure\r
\r
This **Diet Change Population Dynamics Scenario** explores how population-level dietary behaviour evolves through social and psychological drivers, with implications for global consumption patterns and its environmental impacts.\r
\r
Eker et al. (2019) adopt two main feedback mechanisms in the diet change module, grounded in two complementary psychological theories.\r
\r
**Social transmission**, is based on the **Theory of Planned Behavior** ([Ajzen, 1991](<https://doi.org/10.1016/0749-5978(91)90020-T>)), which posits that behavioral intentions are shaped by perceived behavioral control (or self-efficacy), subjective social norms, and individual attitudes-i.e., whether a behavior is evaluated positively or negatively. In this context, diet change driven by social norms forms a **positive feedback loop**: as more individuals adopt a vegetarian diet, the social norm shifts, which in turn further encourages diet change.\r
\r
