...
![Default interface](figures/default_interface.png)
*Default interface.*

![Visualisations for scenario exploration](figures/visualisations.png)
*Different kinds of visualisations for scenario exploration, trade-offs, target alignments, and uncertainty analysis.*
