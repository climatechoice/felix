...
\r
<img src="diagrams/flw_sc.png" alt="flw sc Diagram" style="display: block; margin: 0 auto 20px auto; max-width: 650px; width: 100%; height: auto;">\r
\r
...
\r
(1) **Primary Production.** This is the stage where crops are harvested or animals are raised for food. _Losses occur due to:_\r
\r
...
\r
(2) **Post-Harvest Handling & Storage.** This is the stage where food is collected, sorted, cleaned, and stored before further processing or transport. _Losses occur due to:_\r
\r
...
\r
(3) **Processing & Packaging.** This is the stage where raw food is transformed into consumer-ready products (e.g., milling, canning, freezing). _Losses occur due to:_\r
\r
...
\r
(4) **Distribution & Retail.** This is the stage where food is transported to retailers and sold to consumers. _Losses occur due to:_\r
\r
...
\r
(5) **Consumption.** This is the stage where food is purchased, prepared, and eaten by consumers or served in food services. _Waste occurs due to:_\r
\r
...
\r
\\*_Source_: Cecilia et al. ([2019](https://link.springer.com/chapter/10.1007/978-3-030-10961-5_11])) based on FAO Data.\r
`;export{e as default};
